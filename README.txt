## ___Краткое описание сервиса:___
...
***
## ___В файл application.properties вынесены настройки проекта:___
...
5. После запуска открыть браузер, перейти по URL: http://localhost:8080/compare_currency/***
6. Вместо "***" указать код валюты, относительно которой необходимо получить курс USD,
